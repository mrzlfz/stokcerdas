...
class AlertConfigurationData {
  ...
  @ApiPropertyOptional({
    description: 'Scheduled maintenance time (ISO string)',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: 'Allow snoozing this alert',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
...
class ScheduleConfiguration {
  ...
  @ApiPropertyOptional({
    description: 'Days of week (0-6, Sunday-Saturday)',
    example: [1, 2, 3, 4, 5],
  })
  @IsOptional()
  @IsArray()
...
export class CreateAlertConfigurationDto {
  ...
  @ApiPropertyOptional({
    description: 'Enable this alert configuration',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Product ID untuk product-specific configuration',
  })
  @IsOptional()
  @IsString()
  productId?: string;
  ...
  @ApiPropertyOptional({
    description: 'Location ID untuk location-specific configuration',
  })
  @IsOptional()
  @IsString()
  locationId?: string;
  ...
  @ApiPropertyOptional({
    description: 'Email addresses untuk external notifications',
  })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  ...
  @ApiPropertyOptional({
    description: 'Schedule configuration untuk recurring alerts',
  })
  @IsOptional()
  @ValidateNested()
