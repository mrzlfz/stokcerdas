...
export class FixWorkflowTriggerType1751637187092 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TYPE "workflow_trigger_type_enum_new" RENAME TO "workflow_trigger_type_enum"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "workflows" DROP COLUMN "triggerType"`,
    );
    ...
    await queryRunner.query(
      `ALTER TYPE "workflows_trigger_type_enum_old" RENAME TO "workflows_trigger_type_enum"`,
    );
