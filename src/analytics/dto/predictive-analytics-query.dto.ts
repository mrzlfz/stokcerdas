...
export class StockoutPredictionQueryDto extends BasePredictiveQueryDto {
  @ApiProperty({
    description: 'Time horizon for stockout prediction',
    enum: TimeHorizon,
    default: TimeHorizon.NEXT_30_DAYS,
  })
  @IsEnum(TimeHorizon)
  ...
  @ApiPropertyOptional({
    description: 'Include products with current low stock only',
    default: false,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Include seasonal factors in prediction',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Consider lead time in predictions',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
...
export class SlowMovingDetectionQueryDto extends BasePredictiveQueryDto {
  @ApiPropertyOptional({
    description: 'Days to look back for movement analysis',
    default: 90,
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiPropertyOptional({
    description: 'Minimum turnover ratio threshold',
    default: 0.5,
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiPropertyOptional({
    description: 'Maximum days without sale to consider slow-moving',
    default: 60,
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiPropertyOptional({
    description: 'Movement categories to include',
  ...
  @ApiPropertyOptional({
    description: 'Include value analysis (slow-moving high-value items)',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
...
export class OptimalReorderQueryDto extends BasePredictiveQueryDto {
  @ApiPropertyOptional({
    description: 'Forecast horizon for reorder calculation',
    enum: TimeHorizon,
    default: TimeHorizon.NEXT_30_DAYS,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Safety stock multiplier (1-3)',
    default: 1.5,
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiPropertyOptional({
    description: 'Consider supplier lead time',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Include economic order quantity (EOQ) calculation',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Maximum budget constraint for reorders',
  })
  @IsOptional()
  @IsNumber()
  @Min(0)
  ...
  @ApiPropertyOptional({
    description: 'Priority products only (high-velocity, high-value)',
    default: false,
  })
  @IsOptional()
  @IsBoolean()
...
export class PriceOptimizationQueryDto extends BasePredictiveQueryDto {
  @ApiPropertyOptional({
    description: 'Current profit margin threshold (%)',
    default: 20,
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiPropertyOptional({
    description: 'Consider competitor pricing',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Include demand elasticity analysis',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Include seasonal pricing recommendations',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Minimum volume threshold for analysis',
    default: 10,
  })
  @IsOptional()
  @IsNumber()
...
export class DemandAnomalyQueryDto extends BasePredictiveQueryDto {
  @ApiPropertyOptional({
    description: 'Sensitivity for anomaly detection (1-10)',
    default: 5,
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiPropertyOptional({
    description: 'Look for positive anomalies (spikes)',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Look for negative anomalies (drops)',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Include seasonal anomalies',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Minimum deviation percentage to consider anomaly',
    default: 25,
  })
  @IsOptional()
  @IsNumber()
...
export class SeasonalAnalysisQueryDto extends BasePredictiveQueryDto {
  ...
  @ApiPropertyOptional({
    description: 'Include weekly patterns',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Include monthly patterns',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Include holiday effects',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Indonesian holiday calendar',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Minimum seasonality strength to report',
    default: 0.3,
  })
  @IsOptional()
  @IsNumber()
...
export class PredictiveAnalyticsQueryDto extends BasePredictiveQueryDto {
  ...
  @ApiPropertyOptional({
    description: 'Specific parameters for the analysis type',
  })
  @IsOptional()
  @Type(() => Object)
  parameters?:
