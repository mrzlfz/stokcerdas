...
export class AutomatedPurchasingService {
  ...
  private buildPurchaseOrderDto(
    ...
    return {
      ...
      type: 'standard',
      priority: reorderCalculation.urgencyScore >= 8 ? 'urgent' : 'normal',
      ...
      expectedDeliveryDate: supplierSelection.predictedDeliveryDate,
      requestedDeliveryDate: supplierSelection.predictedDeliveryDate,
  ...
  private async sendNotifications(
    ...
    const severity = reorderCalculation.urgencyScore >= 8 ? AlertSeverity.HIGH : AlertSeverity.MEDIUM;
