/**
 * Stock Movement Report Screen Component
 * Placeholder untuk stock movement report
 */
...
const StockMovementReportScreen: React.FC = () => {
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        <Text style={styles.title}>Stock Movement Report</Text>
        <Text style={styles.subtitle}>
          Laporan pergerakan stok akan diimplementasikan di sini
        </Text>
      </View>
    </SafeAreaView>
  );
